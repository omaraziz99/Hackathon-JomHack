...
const dispute = computed(() => {
  ...
  return disputeStore.getAiResolvedDisputeById(id);
});

// Computed properties for evidence viewer
...
// Mock data for the tabs (since this wasn't in the store)
const resolutionSteps = ref([
  {
    ...
    details: "System detected clear pattern match",
  },
]);
...
const aiAnalysis = ref([
  {
    type: "success",
    message: "Clear transaction pattern identified",
    matchedRule: "TR-001",
    confidence: 98,
  },
...
const transactionHistory = ref([
  {
    ...
    timestamp: "2023-07-20 15:30",
    description: "System received dispute claim",
    color: "purple",
  },
...
// Computed property for resolution time
const resolutionTime = computed(() => {
  if (!dispute.value) return "N/A";
...
onMounted(async () => {
  if (!dispute.value) {
    ...
    if (!dispute.value) {
      ...
      router.push("/disputes/dashboard");
    }
  }
});
